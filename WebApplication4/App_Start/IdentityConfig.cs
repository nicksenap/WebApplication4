...
namespace WebApplication4
{
    ...
    public class ApplicationUserManager : UserManager<P2PUser>
    {
        public ApplicationUserManager(IUserStore<P2PUser> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<P2PUser>(context.Get<P2PDbContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<P2PUser, string>
    {
