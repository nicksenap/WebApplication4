namespace WebApplication4.Migrations
{
    ...
    public partial class zug : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Loans", "CreationDate", c => c.DateTime(nullable: false, defaultValueSql: "GETUTCDATE()"));
            AlterColumn("dbo.AspNetUsers", "CreationDate", c => c.DateTime(nullable: false, defaultValue: DateTime.Now));
